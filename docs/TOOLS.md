...
| [`zipcheckup_draft_civic_letter`](#zipcheckupdraftcivicletter) | **writes to page state** |
...
## `zipcheckup_draft_civic_letter`

**Draft a letter to the water system about a specific ZIP code**
...
```json
{
  ...
  "properties": {
    "zip": {
      "type": "string",
      "description": "5-digit US ZIP code the letter is about."
    },
    "concern": {
      "type": "string",
    ...
    "tone": {
      ...
      "description": "Register of the letter. Default formal."
    },
    "sender_name": {
      "type": "string",
      "description": "Name to sign with. Omit to leave a placeholder."
    },
    "sender_address": {
      "type": "string",
      "description": "Sender address for the letterhead. Omit to leave a placeholder."
    }
  },
  "required": [
    "zip"
